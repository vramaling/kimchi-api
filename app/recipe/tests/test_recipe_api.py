...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_partial_update(self):
        ...
        payload = {'title': 'New recipe sample'}
        url = detail_url(recipe.id)
    ...
    def test_update_user_returns_error(self):
        """Test changing recipe user will return error"""
        new_user = create_user(email='user2@example.com', password='test4141')
        recipe = create_recipe(user=self.user)
    ...
    def test_recipe_other_user_recipe(self):
        """Test trying to delete recipes by other users"""
        new_user = create_user(email='user2@example.com', password='test4141')
    ...
    def test_create_tag_on_update(self):
        """Test creating a tag when recipe is updated"""
        recipe = create_recipe(user=self.user)
    ...
    def test_update_recipe_tag(self):
        """Test assigning a tag when updating recipe"""
    ...
    def test_create_recipe_with_existing_ingredients(self):
        ...
        payload = {
            ...
            'time_minutes': 35,
            'price': Decimal('12.45'),
            'ingredients': [{'name': 'Salt'}, {'name': 'Cheddar Cheese'}],
        }
        res = self.client.post(RECIPES_URL, payload, format='json')
    ...
    def test_update_recipe_assign_ingredient(self):
        """Test assigning extisting ingredient when updating recipe"""
